...
- A `0-65535` value would not fit, but a rotation vector might. if 255 limited.

### Alternate Ideas

1. **Instruction - Location**  
   Use a second memory drive or the latter half of the first drive. (HARVARD ARCHITECTURE?)
...
## Instruction and Data Layout for Vector Version
